...
@section('content')
    ...
    <table class="table table-striped">
        ...
        @foreach ($candidates as $candidate)
            ...
            >
                ...
                <td class="fit">
                    <a href="{{ route('qualification.show_profile_detailed', $registration->id) }}" target="_blank" class="btn btn-info"><i class="far fa-eye mr-2 fa-xs"></i>@lang('qualification.ViewProfile')</a>
                    @role('admin')
    ...
    <div class="text-center mt-4">
        <a target="_blank" class="btn btn-primary w-50" href="{{ route('qualification.data_export_selection', $question_set->id) }}">@lang('qualification.ExportData')</a>
    </div>
@endsection