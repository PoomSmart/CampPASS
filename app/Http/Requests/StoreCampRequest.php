...
class StoreCampRequest extends CampPASSFormRequest
{
    ...
    public function true_rules()
    {
        $rules = [
            ...
            'short_description_en' => 'nullable|string|max:400|required_without:short_description_th',
            'short_description_th' => 'nullable|string|max:400|required_without:short_description_en',
