...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('qualification')->group(function () {
        ...
        Route::post('/document-approve-interview-save/{camp}', 'CandidateController@document_approve_interview_save')->name('qualification.document_approve_interview_save');
        Route::get('/interview-announce/{camp}', 'CandidateController@interview_announce')->name('qualification.interview_announce');
        ...
        Route::get('/rank/{camp}', 'CandidateController@rank')->name('qualification.candidate_rank');
        Route::post('/announce/{camp}', 'CandidateController@announce')->name('qualification.candidate_announce');
        Route::get('/result/{camp}', 'CandidateController@result')->name('qualification.candidate_result');
        Route::get('/data-export-selection/{camp}', 'CandidateController@data_download_selection')->name('qualification.data_download_selection');
        Route::get('/data-download/{camp}', 'CandidateController@data_download')->name('qualification.data_download');
    ...
    Route::prefix('statistics')->group(function () {
        Route::get('/statistics/{camp}', 'StatisticsController@statistics')->name('statistics.statistics');
    });
